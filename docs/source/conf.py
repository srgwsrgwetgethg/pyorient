...
project = u'pyorient'
copyright = u'2015 mogui, ostico, marcauberer'
...
latex_documents = [
  ('index', 'pyorient.tex', u'pyorient Documentation',
   u'mogui, ostico, marcauberer', 'manual'),
]
...
texinfo_documents = [
  ('index', 'pyorient', u'pyorient Documentation',
   u'mogui, ostico, marcauberer', 'pyorient', 'One line description of project.',
   'Miscellaneous'),
]
